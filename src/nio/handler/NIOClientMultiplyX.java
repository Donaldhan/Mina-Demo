 ...
 * 下午9:33:14
 */
public class NIOClientMultiplyX {
	...
	public static void main(String[] args) throws IOException{
		NIOClientMultiplyX client = new NIOClientMultiplyX();
	...
	public void listen() throws IOException{
		System.out.println("===========The Multiply Client is start!===========");
		while(true){
			selector.select();
			...
			while(ite.hasNext()){
				...
				if(key.isConnectable()){
					...
					proctolCodeBuffer.put(ProtocolConstants.MULTI_PROTOCOL_300100.getBytes(ProtocolConstants.CHARSET_UTF8));
